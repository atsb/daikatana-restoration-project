...
// consolidation change: SCG 3-11-99
		...
		Draw_Fill( 0, VID_HEIGHT-8, VID_WIDTH, 8, rgbColor, 1.0 );
...
// consolidation change: SCG 3-11-99
	CVector rgbColor;
	rgbColor.x = rgbColor.y = rgbColor.z = 1;
  	Draw_Fill( l->generic.x - 112 + l->generic.parent->x, l->generic.parent->y + l->generic.y + l->curvalue*10 + 10, 128, 10, rgbColor, 1.0 );
// consolidation change: SCG 3-11-99
//==================================
	while ( *n )
	{
...
void SpinControl_Draw( menulist_s *s )
{
	...
	if (!s->itemnames[s->curvalue] || !s->itemnames[s->curvalue] || !strchr( s->itemnames[s->curvalue], '\n' ) )
	{
