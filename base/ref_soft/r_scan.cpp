...
extern "C" byte		*r_turb_pbase, *r_turb_pdest;
extern "C" fixed16_t	r_turb_s, r_turb_t, r_turb_sstep, r_turb_tstep;
extern "C" int			*r_turb_turb;
extern "C" int			r_turb_spancount;
...
//	static uint16	*rowptr[MAXHEIGHT+AMP2*2];
...
//	r_turb_pbase = (uint16 *)cacheblock;
...
//		r_turb_pdest = (uint16 *)((byte *)d_viewbuffer +
...
//	pbase = (unsigned char *)cacheblock;
	...
	{
//		pdest = (unsigned char *)((byte *)d_viewbuffer +
		pdest = (uint16 *)((byte *)d_viewbuffer +
				(r_screenwidth * pspan->v) + pspan->u * BYTES_PER_PIXEL);
...
#if	!id386
void D_DrawSpans16_f (espan_t *pspan)
{
	D_DrawSpans16 (pspan);
}
#endif
...
#if	!id386
void D_DrawZSpans_f (espan_t *pspan)
{
	D_DrawZSpans (pspan);
}
#endif
