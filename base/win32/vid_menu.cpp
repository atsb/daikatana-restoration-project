...
void VID_MenuDraw (void)
{
	...
	*/
	...
	M_GetMenuPic ("m_banner_video", dk_path, &w, &h);
//	re.DrawPic( viddef.width / 2 - w / 2, viddef.height /2 - 110, dk_path, RESOURCE_GLOBAL);
	DRAWSTRUCT drawStruct;
	drawStruct.pImage = re.RegisterPic( dk_path, NULL, NULL, RESOURCE_GLOBAL );
	drawStruct.nFlags = DSFLAG_BLEND;
	drawStruct.nXPos = viddef.width / 2 - w / 2;
	drawStruct.nYPos = viddef.height /2 - 110;
