...
//	unsigned short          client;         // set during SetClientState()
//    unsigned short          server;         // set during SetServerState()
//	virtual void            SetNetState();  // called during init
	...
	// void                    *RefModel(char *name, int resource=0);

    ////////////////////////////////////////////////////////////////////
    //**** Initialization and management
	virtual CClientEntity   *Spawn();
	void                    InitManager(CClientEntityManager *man);
	void                    InitBase();
