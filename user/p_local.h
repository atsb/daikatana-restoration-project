...
#define svc_onscreen_icon     6
#define svc_clientdeath       7
#define svc_sidekick_update   8
//#define svc_sidekick_command  9
#define svc_selector          9
#define svc_weapon_icon      10
#define svc_xplevel          11
#define svc_savegem          12
#define svc_clientrespawn    13
